...
import UpdateStatusTaskv1 from "../../components/UpdateStatusTaskv1";
...
const TreeMapManager: React.FC<TreeMapProps> = ({
  ...
  const render = (
    <div className="h-[650px] relative overflow-hidden rounded-lg">
      <MapContainer
        center={areaCenter}
        zoom={minZoom}
        className="h-full"
      ...
      {selectedTree && (
        <div className="absolute top-0 right-0 bg-white p-4 shadow-md z-[1000] h-full">
          <div className="pr-4 border-r flex flex-col h-full">
            <div className="flex-grow">
              ...
              <p>
                <span className="font-bold">Height:</span> {selectedTree.heigh}{" "}
                cm
              </p>
              <p>
          ...
          <div className="flex h-full">
            <div className="pr-4 border-r flex flex-col h-full">
              <div className="flex-grow">
                ...
                <img
                  ...
                  alt="image"
                  className="w-44 h-44 md:w-52 md:h-64 rounded-lg object-cover"
                />
                <p>
                  <span className="font-bold">Tree code:</span>{" "}
            ...
            {selectedTaskTree.assignments &&
              selectedTaskTree.assignments.length > 0 && (
                <div className="pl-4 relative w-48">
                  <div>
                      ...
                      {selectedTaskTree.assignments
                        ...
                        .map((assignment) => (
                          <li key={assignment.id} className="mb-2">
                            ...
                            <div className="absolute bottom-0 left-5 right-0 flex justify-center">
                              {assignment.isRequest ? (
                                "waiting for confirmation"
                              ) : assignment.workContent.every(
                                  (x) => x.status === 1
                                ) ? (
                                <SendRequestConfirm
